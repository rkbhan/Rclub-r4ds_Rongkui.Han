...
#The color gradient follows the numbers on the y axis.
...
#It looks like stroke designates the size of the dots. It also looks like taht it works for the hollow and solid shapes. Not sure about the color-filled ones. 
